...
*   SW Version           : 5.0.0
*   Build Version        : S32K3_RTD_5_0_0_D2408_ASR_REL_4_7_REV_0000_20240830
*
...
#include "libs/core_specific.h"

#ifdef S32K344
    #include "libs/S32K344_SCB.h"
    #include "libs/S32K344_MPU.h"
    #include "libs/S32K344_MSCM.h"
#endif
#ifdef S32K342
    #include "libs/S32K342_SCB.h"
    #include "libs/S32K342_MPU.h"
    #include "libs/S32K342_MSCM.h"
#endif
#ifdef S32K341
    #include "libs/S32K341_SCB.h"
    #include "libs/S32K341_MPU.h"
    #include "libs/S32K341_MSCM.h"
#endif
#ifdef S32K324
    #include "libs/S32K324_SCB.h"
    #include "libs/S32K324_MPU.h"
    #include "libs/S32K324_MSCM.h"
#endif
#ifdef S32K314
    #include "libs/S32K314_SCB.h"
    #include "libs/S32K314_MPU.h"
    #include "libs/S32K314_MSCM.h"
#endif
#ifdef S32K312
    #include "libs/S32K312_SCB.h"
    #include "libs/S32K312_MPU.h"
    #include "libs/S32K312_MSCM.h"
#endif
#ifdef S32K322
    #include "libs/S32K322_SCB.h"
    #include "libs/S32K322_MPU.h"
    #include "libs/S32K322_MSCM.h"
#endif
#if defined(S32K396) || defined(S32K394) || defined(S32K364) || defined(S32K366)
    #include "libs/S32K39_SCB.h"
    #include "libs/S32K39_MPU.h"
    #include "libs/S32K39_MSCM.h"
#endif
#if defined(S32K374) || defined(S32K376)
    #include "libs/S32K37_SCB.h"
    #include "libs/S32K37_MPU.h"
    #include "libs/S32K37_MSCM.h"
#endif
#if defined(S32K358) || defined(S32K328) || defined(S32K338) || defined(S32K348)
    #include "libs/S32K358_SCB.h"
    #include "libs/S32K358_MPU.h"
    #include "libs/S32K358_MSCM.h"
#endif
#ifdef S32K388
    #include "libs/S32K388_SCB.h"
    #include "libs/S32K388_MPU.h"
    #include "libs/S32K388_MSCM.h"
#endif
#if defined(S32K311) || defined(S32K310)
    #include "libs/S32K311_SCB.h"
    #include "libs/S32K311_MPU.h"
    #include "libs/S32K311_MSCM.h"
#endif
#if defined(S32M276) || defined(S32M274)
    #include "libs/S32M27x_SCB.h"
    #include "libs/S32M27x_MPU.h"
    #include "libs/S32M27x_MSCM.h"
#endif
...
#include "libs/Platform_MemMap.h"
